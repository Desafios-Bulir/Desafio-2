    ...
    <section className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Button asChild size="lg" className="bg-slate-950 text-white hover:bg-slate-800 shadow-xl shadow-slate-950/20">
      ...
      <div className="relative">
        <div className="absolute -left-8 -top-8 h-28 w-28 rounded-full bg-slate-300/20 blur-3xl" />
        ...
        <Card className="mt-5 border-slate-200/80 bg-slate-950 text-white shadow-2xl shadow-slate-950/20">
          <CardHeader className="space-y-3 border-b border-white/10 bg-white/5 px-6 py-6">
            <div className="inline-flex w-fit items-center gap-2 rounded-full bg-slate-400/10 px-3 py-1 text-xs font-medium text-slate-200">
          ...
          <CardContent className="grid gap-4 px-6 py-6">
            ...
            <div className="mt-2 flex items-center gap-3 rounded-2xl border border-slate-400/20 bg-slate-400/10 px-4 py-4 text-slate-100">
